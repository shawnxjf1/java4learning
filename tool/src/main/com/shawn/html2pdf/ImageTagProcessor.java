...
/**
 * 参考自：https://stackoverflow.com/questions/13843736/parsing-html-to-pdf-with-itext-image-base64<br>
 */
@Slf4j
                ...
                if (img != null) {
                    try {
                        ...
                        elements.add(getCssAppliers().apply(
                            new Chunk((Image)getCssAppliers().apply(img, tag, htmlPipelineContext), 0,
                                0, true),
